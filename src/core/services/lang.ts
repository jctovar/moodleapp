...
export class CoreLangProvider {
    ...
    protected defaultLanguage = CoreConstants.CONFIG.default_lang || 'en';
    ...
    protected customStrings: CoreLanguageObject = {};
    protected customStringsRaw?: string;

    // Cadenas de texto definidas por plugins del sitio.
    protected sitePluginsStrings: CoreLanguageObject = {};
    ...
    async initialize(): Promise<void> {
        // Establece el idioma de respaldo y el idioma inicial hasta que la aplicación
        // determine el idioma correcto a usar basándose en la configuración del dispositivo o usuario.
     ...
     * Determina el idioma basándose en la configuración del usuario, idioma del dispositivo o idioma por defecto.
     */
