...
export class CoreSyncProvider {
     ...
     * @param id ID único por componente.
     * @param operation Nombre de la operación. Si no está definido, se usa un texto por defecto.
     * @param siteId ID del sitio. Si no está definido, se usa el sitio actual.
     */
     ...
     * @param id ID único por componente.
     * @param siteId ID del sitio. Si no está definido, se usa el sitio actual.
     * @returns Verdadero si el componente está bloqueado, falso en caso contrario.
     */
